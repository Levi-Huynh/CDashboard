  ...
  constructor(props) {
    ...
    componentDidUpdate(prevProps){
        if(this.props.global90 !== prevProps.global90){
          ...
          this.setState({
            series: update(this.state.series, { 0:{data:{$set: this.props.global90.dataDeaths}} })
          })
    ...
    // console.log("GLOBAL CASES:",  this.state.series, "CDU CASES PROPS:",   this.state.options.xaxis, this.state.options.yaxis)
